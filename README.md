...
NANO 대학원(나노과학 전공 및 관련 과정) 학습·연구 참고 자료를 모아두는 저장소입니다. 반도체 공정 이해, 에칭 장비용 정전 초커(ESC) 등 주제별로 차시별 디렉토리로 정리합니다.
...
| `Thermal_and_Electrical_Analysis_of_the_Electrostatic_Chuck_for_the_Etch_Equipment.pdf` | 에칭 장비용 정전 캙(Electrostatic Chuck) 열·전기 특성 분석 논문 |
...
| `business_meeting_emails.docx` | 비지니스 미팅 이메일 예시 |
